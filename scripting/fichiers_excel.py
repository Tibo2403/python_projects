...
fpath = "C:\\USers\\user\\Downloads\\excel\\"
...
wb1 = openpyxl.load_workbook(fpath+"octobre.xlsx", data_only=True)
wb2 = openpyxl.load_workbook(fpath+"novembre.xlsx", data_only=True)
wb3 = openpyxl.load_workbook(fpath+"decembre.xlsx", data_only=True)
...
wb_sortie.save(fpath+"total_ventes_trimestre.xlsx")